      ...
      <div className="bg-white rounded-2xl p-8 max-w-md w-full shadow-lg border border-gray-100 text-center space-y-6">
        ...
        <div className="relative flex items-center justify-center">
          ...
          <button
            ...
            className="bg-white px-3 text-[11px] text-gray-400 hover:text-emerald-600 font-medium transition-all absolute"
          >
        ...
        {/* Email Login Form */}
        <form onSubmit={handleEmailLoginSubmit} className="space-y-3.5 pt-1">
          <input
            type="email"
          ...
          <button
            type="submit"
            disabled={isLoading}
            className="w-full py-3 bg-[#00b050] hover:bg-[#009944] text-white rounded-xl text-xs font-semibold shadow transition-all disabled:opacity-50"
          >
        ...
        <div className="pt-2">
          ...
          >
            Don&apos;t have an account? <span className="text-[#00b050] font-semibold">Sign Up</span>
          </button>
        </div>
      </div>
    </div>
